...
class GalleryIndexerWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            Log.d("GalleryIndexerWorker", "Indexing completed successfully")
            Result.success()
        } catch (e: Throwable) {
            ...
            // Always cancel the notification — WorkManager may not dismiss it reliably
            // when the worker exits silently (e.g. early return from GalleryService).
