                        ...
                        items(viewModel.folders, key = { it.bucketId }) { folder ->
                            FolderTile(
                                ...
                                onClick = {
                                    ...
                                    viewModel.savedGridFirstIndex = foldersGridState.firstVisibleItemIndex
                                    viewModel.savedGridFirstScrollOffset = foldersGridState.firstVisibleItemScrollOffset
